...
app.controller('ctrl1', function($scope){
    ...
    $scope.events = [
        {nameClub: "Bunkier", city: "Gdansk", position: {lat: 54.354750, lng: 18.654678}, name: 'Ludzie ulicy', photo: 'img/foto-event-mini/1.jpg',photo1:'img/foto-event/1.jpg',date: '2016-7-1'},
        {nameClub: 'Mewa Towarzyska', city: 'Sopot', position: {lat: 54.443701, lng: 18.567403}, name: 'Otwarcie ogródka', photo: 'img/foto-event-mini/2.jpg',date: '2016-7-2'},
        {nameClub: 'Absinthe', city: 'Gdansk', position: {lat: 54.351231, lng: 18.648594}, name: 'Zaćmienie', photo: 'img/foto-event-mini/3.jpg',date: '2016-7-3'},
        {nameClub: 'Sfinks 700', city: 'Sopot', position: {lat: 54.448606, lng: 18.567710}, name: 'Cudawianki', photo: 'img/foto-event-mini/4.jpg',date: '2016-7-4'},
        {nameClub: 'Kwadratowa', city: 'Gdansk', position: {lat: 54.370941, lng: 18.615147}, name: 'Pozytwynie', photo: 'img/foto-event-mini/5.jpg',date:'2016-7-5'},
        {nameClub: 'Dream Club', city: 'Sopot', position: {lat: 54.444478, lng: 18.566645}, name: 'Ziemia to za mało', photo: 'img/foto-event-mini/6.jpg',date: '2016-7-6'},
        {nameClub: 'Bunkier', city: 'Gdansk', position: {lat: 54.354750, lng: 18.654678}, name: 'Festiwal trafik', photo: 'img/foto-event-mini/7.jpg',date: '2016-7-7'},
        {nameClub: "B90", city: "Gdansk", position: {lat: 54.354750, lng: 18.654678}, name: 'Garden party', photo: 'img/foto-event-mini/8.jpg',date: '2016-7-8'},
        {nameClub: 'Czekoladowa', city: 'Sopot', position: {lat: 54.454168, lng: 18.554595}, name: 'Wieczor piwa ', photo: 'img/foto-event-mini/9.jpg',date: '2016-7-11'},
        {nameClub: 'SPATiF', city: 'Sopot', position: {lat: 54.444402, lng: 18.567747}, name: 'Techno Night', photo: 'img/foto-event-mini/10.jpg',date: '2016-7-13'},
        {nameClub: 'Protokultura', city: 'Gdansk', position: {lat: 54.443701, lng: 18.567403}, name: 'House Time', photo: 'img/foto-event-mini/11.jpg',date: '2016-7-15'},
        {nameClub: 'Atelier', city: 'Sopot', position: {lat: 54.448602, lng: 18.568387}, name: 'Muzyka elektroniczna', photo: 'img/foto-event-mini/12.jpg',date: '2016-7-17'},
        {nameClub: 'HAH', city: 'Sopot', position: {lat: 54.453064, lng: 18.564116}, name: 'Destroy music', photo: 'img/foto-event-mini/13.jpg',date: '2016-7-19'},
        {nameClub: 'Wtedy', city: 'Sopot', position: {lat: 54.441044, lng: 18.563498}, name: 'Rozpoczecie seonu', photo: 'img/foto-event-mini/14.jpg',date: '2016-7-20'},
        {nameClub: 'Dwie zmiany', city: 'Sopot', position: {lat: 54.443651, lng: 18.5643276}, name: 'Zmiana miejsc', photo: 'img/foto-event-mini/15.jpg',date: '2016-7-21'},
        {nameClub: 'Scena', city: 'Sopot', position: {lat: 54.448498, lng: 18.568309}, name: 'Wystywa Fotografi', photo: 'img/foto-event-mini/16.jpg',date: '2016-7-23'},
        {nameClub: 'TAN', city: 'Sopot', position: {lat: 54.445276, lng: 18.567748}, name: 'Koncert na dachu', photo: 'img/foto-event-mini/17.jpg',date: '2016-7-25'},
        {nameClub: 'Libation ', city: 'Sopot', position: {lat: 54.444583, lng: 18.568565}, name: 'Scena odkryć', photo: 'img/foto-event-mini/18.jpg',date: '2016-7-27'}
